            ...
            <div className="col-12">
               <div className="row mx-0">
                  <div className="col-12 d-flex justify-content-center align-items-center">
                     <div className='d-flex px-2 align-items-center' style={{backgroundColor:"#FFF",border:"solid #FFFF",borderRadius:"8px",boxShadow:"0px 0xp 2px"}}>
                        <span className="pe-1"><input type="text" className='form-control' style={{border:"none"}} placeholder='Type your message here...' /></span>
                        <span className='mx-3'>
                        ...
                        <span className='mx-2 chatBtn'>
                           <Button width='' paddingX='' paddingY='' clickfunc={() => {}} content='send' />
                        </span>
                     </div>
                  </div>
               </div>
